...
class OrganizationSpider(scrapy.Spider):
    name = 'organizationQSSpider'
    allowed_domains = ['gzhfda.gov.cn']
    start_urls = ['http://www.gzhfda.gov.cn/search_searchshow_lx_spsc_p_1_']
    page_num = 1
    ...
    def parse(self, response):
        ...
        if len(orgTable) == 21:
            next_page_url = 'http://www.gzhfda.gov.cn/search_searchshow_lx_spsc_p_%d_' % self.page_num
